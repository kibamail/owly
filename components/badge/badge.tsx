...
import { getResponsiveClassNamesForProp, getVariableClassNamesForProp } from "../../utils/props";
...
export const Badge = forwardRef<ElementRef<"span">, BadgeProps>(
  function BaseBadge(props, ref) {
    ...
    const { className } = getResponsiveClassNamesForProp("size", size, "md");
    const { className: variantClassName } = getVariableClassNamesForProp("variant", variant, 'info');
